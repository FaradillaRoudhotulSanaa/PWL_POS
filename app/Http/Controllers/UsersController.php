...
class UsersController extends Controller
{
    ...
    {   
        ...
        return view('layouts.user.index', ['breadcrumb' => $breadcrumb, 'page' => $page, 'level' => $level, 'activeMenu' => $activeMenu]);
    }
    ...
    public function show(string $id) {
        ...
        return view('layouts.user.show', ['breadcrumb' => $breadcrumb, 'page' => $page, 'user' => $user,'activeMenu' => $activeMenu]);
    }
    ...
    public function edit(string $id){
        ...
        return view('layouts.user.edit', ['breadcrumb' => $breadcrumb, 'page' => $page, 'user' => $user, 'level' => $level,'activeMenu' => $activeMenu]);
    }
